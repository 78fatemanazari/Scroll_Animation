...
<!-- PROJECT DESCRIPTION -->
# 📖 [Scroll Animation] <a name="about-project"></a>

**Scroll Animation** is a simple html page that used css animation to show many divs when you scroll the page. 
...
```sh
  ...
  git clone git@github.com:78fatemanazari/Scroll_Animation.git
```
